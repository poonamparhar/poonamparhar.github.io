...
**Basic features:** These include Java Runtime discovery and Usage Tracking capabilities. These features are accessible to all Java users.
...
<p style="text-align:left;"><img style='border:1px solid #000000' src="../assets/img/jms_managed_Instances.png" ></p>
